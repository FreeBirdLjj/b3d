...
#define setobj(L,obj1,obj2) \
	do{ const TValue *io2=(obj2); TValue *io1=(obj1); \
	  io1->value_ = io2->value_; io1->tt_ = io2->tt_; \
	  checkliveness(G(L),io1); }while(0)
...
#undef setnvalue
#define setnvalue(obj,x) \
	do{ TValue *io_=(obj); num_(io_)=(x); lua_assert(ttisnumber(io_)); }while(0)

#undef setobj
#define setobj(L,obj1,obj2) \
	do{ const TValue *o2_=(obj2); TValue *o1_=(obj1); \
	  o1_->u = o2_->u; \
	  checkliveness(G(L),o1_); }while(0)
...
#undef luai_checknum
#define luai_checknum(L,o,c)	do{ if (!ttisnumber(o)) c; }while(0)
